...
namespace TPM3.chq
{
    class DXDG
    {
        public Document ExecuteOutput_DXDG(string DocPath, string docName, ArrayList DataTreeList, string SaveFileName, string ProjectID, string TestVerID, bool IfOutputAnnex)
        {
           ...
           // outputdoc.OutputChapter_UnderHaveTable("测试类型统计", "测试类型统计表", "测试类型统计表", "可变章节_测试类型统计", doc);
            ...
            outputdoc.OutputChapter_ChangeMuiChapter("测试项", "", false, "定型", IfOutputAnnex);
