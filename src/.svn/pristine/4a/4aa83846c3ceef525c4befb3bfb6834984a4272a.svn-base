...
namespace TPM3.chq
{
    class PR
    {
        public Document ExecuteOutput_PR(string DocPath, string docName, ArrayList DataTreeList, string SaveFileName,string ProjectID,string TestVerID)
        {

            wait_output frmwait;

            frmwait = new wait_output();
            frmwait.progressBar1.Maximum = 6;
            ...
            outputdoc.OutputChapter_QuestionReport(doc);
